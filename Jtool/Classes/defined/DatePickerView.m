...
- (instancetype)initWithWhetherAttachToolBar:(BOOL)whetherAttachToolBar {
    ...
    frame.size = (CGSize){[UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height * 0.4};
...
- (void)createSubviews {
    ...
    UIBarButtonItem *doneItem = [[UIBarButtonItem alloc] initWithTitle:Kok style:UIBarButtonItemStyleDone target:self action:@selector(doneItemDidClicked:)];
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view {
    ...
    switch (unit) {
        ...
        case NSCalendarUnitMonth:
        {
            NSString *currentMonth = [NSString stringWithFormat:@"%ld",(long)row+1];
        ...
        case NSCalendarUnitDay:
        {
            ...
            NSString *currentDay = [NSString stringWithFormat:@"%lu", (row + 1) % (dateRange.length + 1)];
        ...
        case NSCalendarUnitHour:
        {
            NSString *currentHour = [NSString stringWithFormat:@"%ld",(long)row];
        ...
        case NSCalendarUnitMinute:
        {
            NSString *currentMin = [NSString stringWithFormat:@"%02ld",(long)row];
